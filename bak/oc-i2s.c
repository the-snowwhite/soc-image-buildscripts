...
static int oc_i2s_trigger(struct snd_pcm_substream *substream, int cmd,
       struct snd_soc_dai *dai)
{
       struct oc_i2s *i2s = snd_soc_dai_get_drvdata(dai);
...
static int oc_i2s_hw_params(struct snd_pcm_substream *substream,
...
static int oc_i2s_set_fmt(struct snd_soc_dai *dai, unsigned int fmt)
{
       struct oc_i2s *i2s = snd_soc_dai_get_drvdata(dai);
       int val = 0;
...
static int oc_i2s_sysclk(struct snd_soc_dai *dai, int clk_id,
...
static void oc_i2s_shutdown(struct snd_pcm_substream *substream,
       struct snd_soc_dai *dai)
{
       struct oc_i2s *i2s = snd_soc_dai_get_drvdata(dai);
       int mask;
...
static int oc_i2s_dai_probe(struct snd_soc_dai *dai)
{
       struct oc_i2s *i2s = snd_soc_dai_get_drvdata(dai);
...
static const struct snd_soc_dai_ops oc_i2s_dai_ops = {
       .set_sysclk = oc_i2s_sysclk,
       // .set_pll
       //.set_clkdiv = oc_i2s_set_clkdiv,
       // .set_bclk_ratio
        .set_fmt = oc_i2s_set_fmt,
        // .xlate_tdm_slot_mask
        // .set_tdm_slot
        // .set_channel_map
        // .set_tristate
       ...
       //.startup = oc_i2s_startup,
       .shutdown = oc_i2s_shutdown,
       .hw_params = oc_i2s_hw_params,
       // .hw_free
       // .prepare
       .trigger = oc_i2s_trigger,
       // .bespoke_trigger
       // .delay
};

static struct snd_soc_dai_driver oc_i2s_dai = {
       .probe = oc_i2s_dai_probe,
       .playback = {
               .channels_min = 2,
               .channels_max = 2,
...
static const struct snd_soc_component_driver oc_i2s_component = {
       .name = "oc-i2s",
};

static const struct regmap_config oc_i2s_regmap_data_config = {
       .name = "oc_i2s.data",
       .reg_bits = 32,
       .reg_stride = 4,
       .val_bits = 32,
...
static const struct regmap_config oc_i2s_regmap_clk_config = {
       .name = "oc_i2s.clk",
       .reg_bits = 32,
       .reg_stride = 4,
       .val_bits = 32,
